                            ...
                            <div class="mt-4">
                                <div class="p-6 text-gray-900">
                                    <div class="flex justify-between">
                                        ...
                                        <button onclick="generatePDF()" id="btn" class="bg-green-700 px-4 py-1 text-white rounded">Imprimer</button>
                                    </div>
                                    ...
                                    <table class="w-full mt-8">
                                        <thead class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50 dark:text-gray-400">
                                            <tr>
