<template>
    <section id="feature" class="bg-gray-50" style="padding-top: 5rem;">
        ...
        <div class="container-default">
            ...
            <div class="mb-[60px] xl:mb-20 jos" data-jos_once="1" data-jos_animation="fade-up"
                data-jos_timingfunction="ease" data-jos_duration="0.7" data-jos_delay="0.5" data-jos_counter="1">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    ...
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-1.svg"
                                    alt="icon-black-home-7-service-1" width="75" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                                    href="/">Menus Numériques Personnalisés</a>
                                <p>
                                    Créez des menus interactifs et attrayants, adaptés à votre offre et à votre
                                    ambiance.
                                </p>
                            </div>
                        </div>
                ...
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="0.6" data-jos_once="1"
                    ...
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-3.svg"
                                    alt="icon-black-home-7-service-3.svg" width="75" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                ...
                <!-- Service Item -->
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="2.1" data-jos_once="1"
                    data-jos_timingfunction="ease" data-jos_duration="0.7" data-jos_counter="1">
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-8.svg"
                                    alt="icon-black-home-7-service-8" width="60" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                ...
                <!-- Service Item -->
                <!-- Service Item -->
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="1.5" data-jos_once="1"
                    data-jos_timingfunction="ease" data-jos_duration="0.7" data-jos_counter="1">
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-6.svg"
                                    alt="icon-black-home-7-service-6" width="73" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                ...
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="1.2" data-jos_once="1"
                    ...
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-5.svg"
                                    alt="icon-black-home-7-service-5" width="73" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                ...
                <!-- Service Item -->
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="1.8" data-jos_once="1"
                    data-jos_timingfunction="ease" data-jos_duration="0.7" data-jos_counter="1">
                    <div class="hover-solid-shadow h-full after:bg-ColorPurple">
                        <div class="group h-full rounded-[10px] border-2 border-ColorDark bg-white p-[30px]">
                            <div class="mb-[30px] h-[70px] w-auto">
                                <img src="landing/img/icons/icon-black-home-7-service-7.svg"
                                    alt="icon-black-home-7-service-7" width="75" height="70">
                            </div>
                            <div>
                                <a class="mb-4 block text-[22px] font-semibold leading-[1.33] -tracking-[0.5px] text-ColorDark group-hover:text-ColorPurple xxl:text-2xl"
                                    href="/">Intégration avec les Réseaux Sociaux</a>
                                <p>
                                    Permettez aux clients de partager leurs expériences sur les réseaux sociaux et
                                    intégrez les plateformes pour une visibilité accrue.
                                </p>
                            </div>
                        </div>
                    </div>
