                    ...
                    <div class="pb-[60px] pt-20 lg:pb-20 lg:pt-[100px] xl:pt-[120px]">
                        ...
                        <div class="container-default">
                            ...
                            <div class="flex flex-wrap items-center justify-center text-center lg:text-left lg:justify-between gap-8">
                                ...
                                <!-- Section Block -->
                                <a class="btn is-blue is-rounded btn-animation is-large group" href="#"><span>Demarrez maintenant</span></a>
                            </div>
                            <!-- Section Wrapper -->
                        </div>
                        <!-- Section Container -->
                        ...
                        <div class="container-default">
                            ...
                            <div class="grid gap-x-16 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_repeat(3,_auto)] xl:gap-x-24 xxl:gap-x-[134px]">
                                ...
                                <div class="flex flex-col gap-y-6 md:col-span-1 lg:col-span-1">
                                    ...
                                    <ul class="flex flex-col gap-y-[10px] capitalize">
                                        <li>
                                            <a class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline" href="signup.html">Signup</a>
                                        </li>
                                        <li>
                                            <a class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline" href="login.html">Login</a>
                                        </li>
                                        <li>
